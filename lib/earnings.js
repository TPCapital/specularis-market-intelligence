...
async function loadAlphaVantageEarnings(symbols, token) {
  const payload = await fetchJson(`https://www.alphavantage.co/query?function=EARNINGS_CALENDAR&horizon=3month&apikey=${encodeURIComponent(token)}`, { timeoutMs: 10000 });
